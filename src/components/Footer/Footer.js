...
<Grid className='gridItem' container item xs={4}  justifyContent="center"
  alignItems="center"   direction="column" justifyItems="center"
  >
...
<Grid container item xs={4}  justifyContent="center"
  alignItems="center" justifyItems="center"   direction="column"
  >
...
<li> <a href="#">Anti-Racism Pledge</a></li>
<li> <a href="#">Product Vetting</a></li>
